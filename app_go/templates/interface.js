...
const prefix = '{{index .Data "opds_prefix"}}';
const approot = '{{index .Data "approot"}}';
const genre_prfx = '{{index .Data "genre_prefix"}}';
const lang_authors = '{{index .Data "lang_authors"}}';
const lang_links = '{{index .Data "lang_links"}}';
const lang_genres = '{{index .Data "lang_genres"}}';
const lang_lang = '{{index .Data "lang_lang"}}';
const new_window = {{index .Data "new_window"}};
...
function initDarkMode() {
    ...
    if (savedTheme === 'dark') {
        ...
        if (themeBtn) {
            ...
            if (img) img.src = '{{index .Data "approot"}}/sun.svg';
            if (img) img.alt = '☀️';
        }
    } else {
        ...
        if (themeBtn) {
            const img = themeBtn.querySelector('img');
            if (img) img.src = '{{index .Data "approot"}}/moon.svg';
            if (img) img.alt = '🌙';
        }
    }
}
