...
## Small parts
  ...
  * indexing:
    ...
    * [bug] `vector` parameter need run several times with different max_pass_lenth for process all books (may be rewrite into .zip.list processing?) -- testing
  * opds:
    * [BUG] after inter-booklist navigaton (next page in genre, from author's sequence to sequence, reload by link) page MUST scroll to beginnig -- testing
  ...
  * docs:
    ...
    * [maybe] spec to THIS library opds output -- partially
